...
try:
    ...
    while True:
        ...
        client.publishEvent(typeId="RaspberryPi", deviceId="1", eventId="imu_acc", msgFormat="json", data=acc_event_data, onPublish=publishAccCallback)
        client.publishEvent(typeId="RaspberryPi", deviceId="1", eventId="imu_gyro", msgFormat="json", data=gyr_event_data, onPublish=publishGyroCallback)
